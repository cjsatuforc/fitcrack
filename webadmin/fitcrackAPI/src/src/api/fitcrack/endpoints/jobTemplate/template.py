...
class rule(Resource):
    ...
    def get(self, id):
        ...
        return {
            'name': 'test',
            'data': '{"hosts_ids":[{"id":1,"domain_name":"DESKTOP-B22HVA6","ip_address":"10.0.75.1","p_model":"Intel(R) Core(TM) i3-8350K CPU @ 4.00GHz [Family 6 Model 158 Stepping 11]","os_name":"Microsoft Windows 10","user":{"name":"Matus"},"last_active":{"last_seen":"2018-08-07 14:14:25","seconds_delta":"6","online":true},"deleted":false}],"seconds_per_job":3600,"attack_settings":{"attack_mode":0,"attack_name":"dict","rules":{"id":2,"name":"netsearch.txt","time":"2018-08-07T13:16:33"},"left_dictionaries":[{"id":1,"name":"hashcatForumPassword.txt","keyspace":100,"time":"2018-08-07T11:52:50"},{"id":2,"name":"reverseRules.txt","keyspace":100,"time":"2018-08-07T13:26:42"}]},"hash_settings":{"hash_type":"0"}}'
        }
